...
<body>
  ...
  <section class="py-11 bg-light-gradient border-bottom border-white border-5">
    ...
    <section>
      <div class="container">
        <form action="" id="frm_login" class="needs-validation" novalidate>
          <div class="row h-100 g-0">
            <div class="col-md-6">
              <div class="bg-300 p-4 h-100 d-flex flex-column justify-content-center">
                <h1 class="fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6">Entra a tu cuenta</h1>
                <label class="mb-5 fs-1" for="usuario">
                  Nombre de usuario
                ...
                <label class="mb-5 fs-1" for="clave">
                  Contraseña
                ...
                <div class="d-grid gap-2 d-md-block">
                  <input type="submit" id="btn_iniciar_sesion" class="btn btn-lg btn-dark" value="Iniciar Sesión">
                  <a class="nav-link fw-medium active" href="/registrate" id="btn_enviar_registro">¿No tienes cuenta? Regístrate</a>&nbsp;&nbsp;
                </div>
              </div>
            </div>
            <div class="col-md-6">
